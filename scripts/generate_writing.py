...
ROOT = Path(r"G:\My Drive\100. Zee\Munyachipunza.com")
...
LOCAL_POSTS = [
    ...
    },
    {
        ...
        "summary": "A reflection on the mercy of not becoming the sharpest version of yourself when hurt shows up first.",
        "excerpt": "A reflection on the mercy of not becoming the sharpest version of yourself when hurt shows up first. Sometimes love is what you refuse to release.",
        ...
        "paragraphs": [
            ...
            "No one knows how close you were. No one sees the words you deleted. No one sees the breath you took before answering differently. No one sees the part of you that wanted to harden, but didn’t get to lead.",
